...
author: "Nicole Hemming-Schroeder | Ph.D. Candidate"
...
We're going to look at a small window of data in the Sierra Nevada ecoregion of California east of Fresno. 
...
The objective of this Markdown file is to get a sense of some of the things you can do with lidar data using R. The functions used throughout have a lot of documentation (e.g. https://r-lidar.github.io/lidRbook/io.html#plot for plotting lidar files) to help determine what inputs they need and how you can customize them that helped lead to how they're written in here.

Possible solutions to questions in the file are at the end.
...
Update the working directory to the location where you stored and opened the zipped trees folder.

```{r}
# Change this working directory to where you stored the zipped trees folder
wd <- "D:/Basic_Website/Website"
setwd(wd)

lidar_dir <- "D:/Basic_Website/Website/NEON/lidar"
```
...
If you have many files of the same type in a folder, you can list and loop through them in a for-loop in your workflow. In this example, we'll look through the list without a loop.
